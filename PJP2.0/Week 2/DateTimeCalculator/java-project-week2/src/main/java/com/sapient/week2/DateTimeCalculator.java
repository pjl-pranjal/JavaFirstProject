...
public class DateTimeCalculator {
    ...
    // for each calculator session
    // records stored as hashmap strings
    // can be written to file, file name contains timestamp for uniqueness
    ...
    public void subtract(CustomDate date) {
        ...
        record.put("input1", this.inputDate.toString());
        record.put("input2", date.toString());
